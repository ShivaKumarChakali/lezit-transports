...
import { ThemeProvider } from './premium/theme/ThemeProvider';

const PremiumApp = React.lazy(() => import('./premium/PremiumApp'));
const PremiumLoginPage = React.lazy(() => import('./premium/pages/LoginPage'));
const PremiumRegisterPage = React.lazy(() => import('./premium/pages/RegisterPage'));
          ...
          <Layout>
            ...
            >
              <Routes>
                ...
                <Route path="/premium/register" element={<PremiumRegisterPage />} />
                <Route
                  path="/premium/*"
                  element={
                    <ProtectedRoute>
